...
################################################################################
## Form generated from reading UI file 'Fire_Detected.ui'
##
...
"}")
        ...
        self.SDetect_header.setMinimumSize(QSize(400, 200))
        self.SDetect_header.setMaximumSize(QSize(16777215, 300))
        font1 = QFont()
...
"to send a report to BFP?", None))
        # self.SDetect_header.setText(QCoreApplication.translate("Dialog", u"A Fire has been Detected!", None))
