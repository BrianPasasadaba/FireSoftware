...
"}")
        ...
        self.ipinfo_feed3 = QLabel(self.groupBox_7)
        ...
        self.gridLayout_8.addWidget(self.ipinfo_feed3, 0, 0, 1, 1)

        self.lb_feed3 = QLabel(self.groupBox_7)
        self.lb_feed3.setObjectName(u"lb_feed3")
        self.lb_feed3.setFont(font6)
        self.lb_feed3.setAlignment(Qt.AlignCenter)

        self.gridLayout_8.addWidget(self.lb_feed3, 1, 0, 1, 1)
        ...
        self.lb_feed2 = QLabel(self.groupBox_6)
        self.lb_feed2.setObjectName(u"lb_feed2")
        self.lb_feed2.setFont(font6)
        self.lb_feed2.setAlignment(Qt.AlignCenter)

        self.gridLayout_7.addWidget(self.lb_feed2, 1, 0, 1, 1)

        self.ipinfo_feed2 = QLabel(self.groupBox_6)
        ...
        self.gridLayout_7.addWidget(self.ipinfo_feed2, 0, 0, 1, 1)
